...
public Principal(){
    ...
    nombreAdministrador = ventaBienvenida.texto;
...
public void actionPerformed(ActionEvent e){ //inicio del evento 

    if(e.getSource() == miCalculo){//inicio calculo
        ...
        Departamento.equals("") || Antiguedad.equals("")){//inicio del if else
          JOptionPane.showMessageDialog(null, "Debes llenar todos los campos.");
         }//fin del if antes del else
        else{//inicio del else

            if(Departamento.equals("Atencion al Cliente")){//inicio de departamento
       ...
       }//fin departamento gerencia 

        }//fin del else

    }//fin del calculo

    if(e.getSource() == miRojo){//inicio del rojo
        getContentPane().setBackground(new Color(255,0,0));
    }//fin del rojo
    if(e.getSource() == miNegro){//inicio del negro
        getContentPane().setBackground(new Color(0,0,0));
    }//fin del negro
    if(e.getSource() == miMorado){//inicio del morado
        getContentPane().setBackground(new Color(51,0,51));
    }//fin del morado
    if(e.getSource() == miNuevo){//inicio del nuevo
    ...
    if(e.getSource() == miSalir){//inicio del salir
    ...
    if(e.getSource() == miElCreador){//inicio del creador
        JOptionPane.showMessageDialog(null, "Desarrollado por Omar Mosquera");
    }//fin del creador
